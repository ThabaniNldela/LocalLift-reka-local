  ...
  return (
    <header className="sticky top-0 z-40 shadow-md">
      ...
      <div className="bg-emerald-800 px-4 py-1.5 text-center text-xs font-medium text-amber-200">
        🇿🇦 Supporting South African vendors from Pretoria to Cape Town
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-800 shadow-md">
              <span className="text-amber-300 font-black text-xl leading-none">
                R
              </span>
            </div>
            <div>
              <p className="text-lg font-extrabold text-emerald-900 leading-tight tracking-tight">
                Reka Local
              </p>
              <p className="text-[10px] font-semibold uppercase tracking-[0.25em] text-amber-500">
                Community Commerce
              </p>
            </div>
          </button>
        ...
        {mobileOpen && (
          <div className="border-t border-stone-100 bg-white px-4 pb-4 pt-2 lg:hidden">
            ...
            <div className="mt-3 flex gap-2 border-t border-stone-100 pt-3">
              {isAuthenticated ? (
                <Button fullWidth onClick={logout} variant="ghost">
                  Sign out
                </Button>
              ) : (
                <>
